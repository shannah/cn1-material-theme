 ...
 * @author Shai Almog
 */
public class MaterialThemeStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "MaterialTheme";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new MaterialThemeStub());
    }
